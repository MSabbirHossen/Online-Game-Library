        ...
        >
          <div className="flex gap-12">
            ...
            {developers.map((dev, idx) => (
              <div
                key={idx}
                className="group relative w-48 h-24 flex items-center justify-center rounded-xl overflow-hidden cursor-pointer"
              >
                {/* glow */}
                <div className="absolute inset-0 bg-cyan-400/10 opacity-0 group-hover:opacity-100 blur-xl transition duration-500"></div>
                ...
                <div className="relative z-10 w-full h-full bg-black/40 backdrop-blur-md border border-gray-700/40 rounded-xl flex items-center justify-center transition duration-300 group-hover:scale-105">
                  <span className="text-lg font-semibold text-gray-200 group-hover:text-cyan-300 transition">
                    {dev}
                  </span>
                </div>
