    ...
    <section className="relative py-24 overflow-hidden bg-gray-900 text-center">
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-4">
        ...
        >
          ...
          <Link
            to="/explore"
            className="inline-flex items-center gap-2 px-10 py-3 rounded-lg bg-cyan-500 text-black font-semibold hover:bg-cyan-400 transition hover:scale-105 shadow-lg shadow-cyan-500/20"
          >
